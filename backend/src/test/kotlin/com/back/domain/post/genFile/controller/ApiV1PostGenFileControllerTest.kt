...
import com.back.global.app.AppConfig.Companion.tempDirPath
...
class ApiV1PostGenFileControllerTest {
    ...
    fun t3() {
        ...
        val postGenFile = postService.findById(9).getOrThrow()
            .getGenFileById(1)
            .get()
    ...
    fun t5() {
        ...
        val copyFilePath = tempDirPath + "/copy_" + postGenFile.fileName
    ...
    fun t8() {
        ...
        val postGenFile = postService.findById(5).getOrThrow()
            .getGenFileByTypeCodeAndFileNo(PostGenFile.TypeCode.thumbnail, 1)
            .get()
